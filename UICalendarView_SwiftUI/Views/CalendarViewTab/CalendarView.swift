...
class Users {
    ...
    var events : [Event]
    var groups : [Grouping]
    init(name: String, events: [Event], groups : [Grouping]) {
        self.name = name
        self.events = events
        self.groups = groups
    }
    init(name: String) {
        self.name = name
        self.events = [Event]()
        self.groups = [Grouping(title: "Demo Party!")]
    }
...
struct Main {
    ...
    var aEvents : [Event]
    var sEvents : [Event]
   // var medha = Users(name: "Medha", events: )
    var users = [Users(name: "Medha"),Users(name: "Arohi"), Users(name: "Sarah")]
